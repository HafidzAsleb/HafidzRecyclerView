...
class SepatuAdapter (private val context: Context, private val sepatu: List<Sepatu>, val listener: (Sepatu) -> Unit)
    ...
    override fun onBindViewHolder(holder: SepatuViewHolder, position: Int) {
        holder.bindView(sepatu[position], listener)
    }

    override fun getItemCount(): Int = sepatu.size
}